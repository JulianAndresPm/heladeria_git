...
ALTER TABLE carrito ADD COLUMN precioTot INT(10);
...
INSERT INTO db_ice.productos(NombreProducto,disponibilidad,stock,precioxUni,descripcion)
	VALUES('Choco Cono',1,300,2000,'Helado de vainilla envuelto de chocolate');
